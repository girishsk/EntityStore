...
/** * Stateful API for reading from a fact oriented database, 
 * which is a sequence of fact records ordered from earliest to 
 * latest. The state is in the form of a cursor that is 
 * positioned either (a) before the earliest record, 
 * (b)  between two records, (c) after the latest record. */
